...
'getAlarmlist':function(va)
{
    ...
    if (this.alarm_end > Ifpms.Xpcom.DCMgmt.alarm_history.length) {
...
'redrawTable':function()
{
 ...
 // this.currentpage=1;
  ...
  jsdump("currentpage: "+this.currentpage);
  this.showCurrentPage();
},
...
alarmObserver.prototype={
     ...
     if(alarmObj.aid != 10 && paname != "环境自适应探测器"){
  	 ...
  	 if (ar[2]==7||ar[2]==8)//断纤ar[2]==5||  开盖  恢复  不用弹出对话框
  	 {
  	    return;
  	 }
     var pa={};
